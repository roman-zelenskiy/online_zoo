let elMenu = document.getElementsByClassName('menu_nav')[0].children;
...
(function activeMainMenu() {
    for (el of elMenu) {
        if (el.children[0].href === document.URL) {
...
} else if (document.URL.includes('online_zoo/map.html')) {
 
    // function onClickMenuFunc(e) {
    //     for (el of elMenu) {
